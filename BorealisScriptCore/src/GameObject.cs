...
namespace Borealis
{
    public class GameObject : Object
    {
        ...
        public bool HasComponent<T>() where T : Component => InternalCalls.Entity_HasComponent(GetInstanceID(), typeof(T));
        public bool HasComponent(Type type) => InternalCalls.Entity_HasComponent(GetInstanceID(), type);
        public void RemoveComponent<T>() where T : Component => InternalCalls.Entity_RemoveComponent(GetInstanceID(), typeof(T));
